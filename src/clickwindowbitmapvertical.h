...
#define SYMBOL_CCLICKWINDOWBITMAPVERTICAL_STYLE wxCAPTION|wxSTAY_ON_TOP|wxTAB_TRAVERSAL
#define SYMBOL_CCLICKWINDOWBITMAPVERTICAL_TITLE _("Click Window Bitmap")
