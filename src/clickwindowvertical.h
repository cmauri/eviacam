...
#define SYMBOL_CCLICKWINDOWTEXTVERTICAL_STYLE wxCAPTION|wxSTAY_ON_TOP|wxTAB_TRAVERSAL
#define SYMBOL_CCLICKWINDOWTEXTVERTICAL_TITLE _("Click Window Vertical")
